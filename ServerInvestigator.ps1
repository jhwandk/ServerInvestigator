...
$StartTime = Get-Date "01/06/2025 08:00:00 AM"
$EndTime = Get-Date "01/06/2025 08:10:00 AM"
...
} | Select-Object TimeCreated, Id, Message | Out-File -FilePath C:\RelevantFilteredEvents_Full.txt -Width 300
